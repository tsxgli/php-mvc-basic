                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" class="form-control" id="addPostcode" name="addPostcode" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-12 col-md-6">
                    ...
                    <div class="row">
                        ...
                        <br><br> <button type="submit" class="btn btn-warning" id="addUserBtn" name="addUserBtn">Add User</button>
                        </div>
            </form>
        </div>
    </div>
