                ...
                <div class="col">
                    <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="imageSelector">
                    ...
                    <div class="row">
                        ...
                        <input class="text-center" name="editTitle" value="<?php echo $model[0]->getTitle();?>"></input>
                    </div>
                    <div class="row">
                        <h3 class="pr-1">Description</h3>
                        <input class="text-left ml-20" name="editDescription" value="<?php echo $model[0]->getDescription();?>"></input>
                    </div>
                    <div class="row">
                        <h3>Director</h3>
                    ...
                    <div class="row">
                        <h3>Date Produced</h3>
                        <input type="date"value="<?php echo $model[0]->getDateProduced();?>" name="editDateProduced"></input>
                    </div>
                    <div class="row">
                        <h3>Genre</h3>
                    ...
                    <div class="row">
                        <form action="/cart?id=<?php echo $model[0]->get_id();?>" method="POST">
                            <br><button type="submit" class="btn btn-warning" name="updateMovieBtn">
                                Update</button>
                        </form>
                    </div>
                </div>
