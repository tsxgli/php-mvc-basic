              ...
              <div class="col-lg-8">
                <div class="p-5">
                  ...
                  <div class="row mb-4 d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-3">
                      <h6 class="text-muted">Shirt</h6>
                      <h6 class="text-black mb-0">Cotton T-shirts</h6>
                    </div>
                    <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                      <button class="btn btn-link px-2"
                        onclick="this.parentNode.querySelector('input[type=number]').stepDown()">
                ...
                <div class="p-5">
                  ...
                  <div class="mb-5">
                    <div class="form-outline">
                      <input type="text" id="checkoutEmailInput" class="form-control form-control-lg" />
                      <label class="form-label" for="checkoutEmailInput">Enter your email</label>
                    </div>
                  </div>
                  <div class="mb-4 pb-2">
                  <label class="form-label" for="checkoutEmailInput">Choose payment method</label>
                    <select class="select">
